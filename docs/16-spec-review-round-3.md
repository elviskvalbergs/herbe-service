...
§1 items closed 2026-07-06: **crew model confirmed — one shared multi-person activity is primary** (1.1; the `dl0dp4` per-person answer is retired with its branch), and the stale herbe-service session branches (`5l1cby`, `9a23yu`, `y0zu1u`, `6v7x5r`, `dl0dp4`, `j9xlbi`, `kva02d`) were deleted — `spec-review-gaps-ukjna3` is the canonical spec branch. Remaining from 1.4: landing the portal service-modules spec on the portal's Bitbucket mainline (the portal/calendar mirror branches stay until then).
