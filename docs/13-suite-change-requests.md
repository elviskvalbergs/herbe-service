...
| POR-2 | portal | Delivery-confirmation (signoff) flow accepts our order report + compliance docs (activity vessel) | Phase 2 | config/small feature | on-site canvas signature + emailed report PDF |
