...
| POR-4 | portal | ~~Native service-data feed~~ — **reduced 2026-07-07**: near-term = worksheet-approval trigger (`POST /api/ext/v1/worksheets/{id}/confirm`); wider module = portal team's own scope | service Phase 1 (API) | reduced/committed | non-portal tenants: emailed report PDF + on-site canvas signature |
