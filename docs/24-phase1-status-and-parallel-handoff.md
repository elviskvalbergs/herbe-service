...
Last updated: **2026-07-16, rev 2** (preview @ PR #9 sync-runner + PR #10 phase-2-recurrence; WS1 status corrected from "Done" to "substrate only" — verified against the repo).
