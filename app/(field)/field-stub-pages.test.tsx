...
//
// Covers the 4 field-shell tab stubs (Jobs/Scan/Inbox/More) that Task 5
// creates as honest "coming soon" chrome — same session-gate shape as
...
// test file (one test database) rather than 4 near-identical page.test.tsx
// files, since there's nothing page-specific to isolate beyond the title
// text — same seams/mocks as app/page.test.tsx.
...
const STUB_PAGES = [
  ...
  { name: 'MorePage', modulePath: './more/page', title: 'More' },
] as const
