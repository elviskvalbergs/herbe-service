...
// JobsPage links to the detail page with next/link's Link, which crashes on
// import under this project's forced 'react-server' resolve condition (see
// components/field-tab-bar.test.ts for the full explanation) — stubbed here
// purely to make the module loadable.
